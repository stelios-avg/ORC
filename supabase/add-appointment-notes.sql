...
begin
  ...
  insert into public.appointments (patient_id, service, start_time, end_time, status, notes)
  values (v_patient_id, 'Online κράτηση', p_start, p_end, 'confirmed', nullif(trim(p_concern), ''))
